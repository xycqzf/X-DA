...
unsigned int nStakeMinAge = 60 * 60 * 24 * 365;	// minimum age for coin age: 1d
unsigned int nStakeMaxAge = 60 * 60 * 24 * 3650;	// stake age of full weight: 100d
unsigned int nStakeTargetSpacing = 60;			// 60 sec block spacing

int64 nChainStartTime = 1456915403;
...
int64 GetProofOfWorkReward(int nHeight, int64 nFees, uint256 prevHash)
{
    ...
    if(nHeight == 1)
    {
        nSubsidy = 137000000 * COIN;	// 1 billion coins, that all pow coins
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "2017/1/9 AM 11:00 build XYCQcoin in office.";
        CTransaction txNew;
        ...
        printf("block.nNonce = %u \n", block.nNonce);
			block.print();
        assert(block.hashMerkleRoot == uint256("0x153e6523f4e79fe59d09e32f8b33b94c3dc5d170fc0cc82055d746fd881e8230"));
...
unsigned char pchMessageStart[4] = { 0x19, 0x61, 0x7c, 0x95 };
