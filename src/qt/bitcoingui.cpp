    ...
    rpcConsole(0)
{
    ...
    resize(850, 550);
    setWindowTitle(tr("XYCQcoin") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    ...
    labellogotext->setGeometry(QRect(80, 13, 270, 60));
...
{
    QSettings setting("XYCQcoin.conf", QSettings::IniFormat);
...
void BitcoinGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/bitcoin"), tr("&About XYCQcoin"), this);
    aboutAction->setToolTip(tr("Show information about XYCQcoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for XYCQcoin"));
...
void BitcoinGUI::setClientModel(ClientModel *clientModel)
{
    ...
    if(clientModel)
    {
        ...
        if(clientModel->isTestNet())
        {
            ...
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("XYCQcoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("XYCQcoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to XYCQcoin network", "", count));
}
...
void BitcoinGUI::viewBlockWebPage()
{
    ...
    //{
        if (!QDesktopServices::openUrl(QUrl("http://118.178.93.12:8099")))
        {
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid XYCQcoin address or malformed URI parameters."));
    }
